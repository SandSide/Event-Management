...
public class Tree {
	...
	public Tree() 
	{
		...
		root = null; // Sets root to equal null.
	...
	public boolean isTreeEmpty() 
	{
		...
		boolean empty = false; // Sets boolean empty to equal false.
		
		if(this.getRoot() == null)  // If getRoot is empty then empty equals true.
		{
			
			empty = true;
			
		}
		else // Else empty equals false.
		{
	...
	/**
     * Search the Binary Tree to find a TreeNode containing input parameter name.
     * 
	...
	/**
     * Delete TreeNode in BInary Tree containing name as the input parameter.
     * 
     * @param name which will be searched for.
     *               
     */	
	...
	/**
	 * 
	 * @param name which is used to find in diary.
	 * @return null
	 */
	public Diary findDiary(String name) 
	{
		...
		if(searched != null) // If searched isn't equal to null then return the name.
		{
	...
	public void searchGroup()
	{
		...
		TreeNode found; // Creates a TreeNode found.
		...
		boolean valid = true; // boolean valid is equal to true.
		...
		Todayyear = Todayyear + 1900; // Creates and initialises todayyear to equal to current year - 2018.
		date = Todayday + "/" + Todaymonth + "/" + Todayyear;
			
		S8 = new Scanner(System.in);
			
		System.out.println(); // Prompts user to enter group of people.
		System.out.println();
		...
		while(num<1 || num>31) // While input is out-with range, output error message and prompt user to enter again.
		{
		...
		while(num<1 || num>12) // While input is out-with range, output error message and prompt user to enter again
		{
		...
		System.out.println(); //Asks user to enter the year of event.
		...
		while(num < nowYear) // While input is out-with range, output error message and prompt user to enter again
		{
		...
		while(num <8 || num > 17) // While input is out-with range, output error message and prompt user to enter again
		{
		...
		if(num == 0 || num == 15 || num == 30 || num == 45 || num ==60) // If statement that sets valid to true if any of the conditions are met.
		{
		...
		while(valid == false) // While valid is equal to false, invalid input message and prompt user to enter again.
		{
		...
		for(int i = 0; i < parts.length; i++) 
		{
			...
			if(found == null) // If not found then valid equals false.
			{
		...
		Set<String> setB = new HashSet<String>(); // Creates a new set called setB
		
		if(valid == true) // IF valid is equal to true then add newarray to set.
		{
			...
			for(int i = 1; i < parts.length; i++) 
			{
				...
				setA.retainAll(setB); // Retains all in both sets.
				
			}
			// Sorts the contents of the set.
